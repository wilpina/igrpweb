<xsl:stylesheet
                                                            ...
                                                            <div role="form">
                                                                ...
                                                                <xsl:if test="rows/content/form_1/fields/data_source">
                                                                    <div class="col-sm-3 form-group  gen-fields-holder" item-name="data_source" item-type="select" required="required">
                                                                        ...
                                                                        <select class="form-control select2 IGRP_change" id="form_1_data_source" name="{rows/content/form_1/fields/data_source/@name}" required="required">
                                                                            <xsl:call-template name="setAttributes">
    ...
    <xsl:include href="../../../xsl/tmpl/IGRP-functions.tmpl.xsl?v=1512654036156"/>
    <xsl:include href="../../../xsl/tmpl/IGRP-variables.tmpl.xsl?v=1512654036156"/>
    <xsl:include href="../../../xsl/tmpl/IGRP-home-include.tmpl.xsl?v=1512654036156"/>
    <xsl:include href="../../../xsl/tmpl/IGRP-utils.tmpl.xsl?v=1512654036156"/>
    <xsl:include href="../../../xsl/tmpl/IGRP-form-utils.tmpl.xsl?v=1512654036156"/>
    <xsl:include href="../../../xsl/tmpl/IGRP-table-utils.tmpl.xsl?v=1512654036156"/>
</xsl:stylesheet>
